...
risk_pr[,1] <- c(0.29, 0.15, 0.11, 0.07, 0.07, 0.01, 0.005)
risk_pr[,2] <- c(0.34, 0.19, 0.11, 0.09, 0.06, 0.03, 0.015)
risk_pr[,3] <- c(0.35, 0.35, 0.35, 0.18, 0.18, 0.09, 0.045)
...
d_divide2 <- d_denom_obs/d_denom2
d_divide3 <- d_denom_obs/d_denom3
...
tested_m <- round(tested_m/d_divide2 )
tested_f <- round(tested_f/d_divide2 )
tested_msm <- round(tested_msm/d_divide3 )
...
# make 10x the data 
d_tested_m_r1 <- round(d_tested_m_r1/d_divide2 )
d_tested_m_r2 <- round(d_tested_m_r2/d_divide2 )
d_tested_f_r1 <- round(d_tested_f_r1/d_divide2 )
d_tested_f_r2 <- round(d_tested_f_r2/d_divide2 )
...
tested_msm2 <- round(tested_msm2/d_divide3 )
...
tested_recent_m2 <- round(tested_recent_m2/d_divide2 )
tested_recent_f2 <- round(tested_recent_f2/d_divide2 )
tested_recent_msm2 <- round(tested_recent_msm2/d_divide3 )

tested_recent_msm <- round(tested_recent_msm/d_divide3 )

...
read.csv(here("prep_denominator/data/AtlasPlusTableData_national_popsize.csv"), skip=10)  %>%
...
read.csv(here("prep_denominator/data/AtlasPlusTableData_population_2000_2022.csv"), skip=7)  %>%
  mutate(year = ifelse(Year == "2020 (COVID-19 Pandemic)", 2020, as.numeric(Year))) %>%
